...
class ComplaintRow(Base):
    ...
    incident_latitude: Mapped[float] = mapped_column(Float)
    incident_longitude: Mapped[float] = mapped_column(Float)
    reporting_latitude: Mapped[float] = mapped_column(Float)
    reporting_longitude: Mapped[float] = mapped_column(Float)
