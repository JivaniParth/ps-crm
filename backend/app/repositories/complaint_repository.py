...
class SQLComplaintRepositoryAdapter:
        ...
        self._store.upsert_complaint(
            {
                ...
                "incident_latitude": complaint.incident_latitude,
                "incident_longitude": complaint.incident_longitude,
                "reporting_latitude": complaint.reporting_latitude,
                "reporting_longitude": complaint.reporting_longitude,
                "ward": complaint.ward,
    ...
    def _to_model(self, row) -> Complaint:
        return Complaint(
            ...
            channel=row.channel,
            incident_latitude=row.incident_latitude,
            incident_longitude=row.incident_longitude,
            reporting_latitude=row.reporting_latitude,
            reporting_longitude=row.reporting_longitude,
            ward=row.ward,
